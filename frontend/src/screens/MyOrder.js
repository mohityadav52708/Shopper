    ...
    return (
        <div>
            ...
            <div className='container'>
                ...
                {Object.keys(orderData).length !== 0 && orderData.orderData ? orderData.orderData.map(data => {
    return (
        data.order_data ?
                        ...
                        return (
                            <div key={arrayData.id}>
                                {arrayData.Order_date ? <div className='m-auto mt-5'>
                                    {/* Assuming you want to set data to arrayData.Order_date */}
                                        ...
                                        <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" }}>
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className='container w-100 p-0' style={{ height: "38px" }}>
                                                    ...
                                                    {/* Assuming you want to display arrayData.Order_date */}
